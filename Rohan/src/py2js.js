...
function $DefCtx(context){
    ...
    this.transform = function(node,rank){
        ...
        // If the function has been defined as a callback for a DOM event, the
        // error message must be printed on the standard error stream
            ...
            if(is_simple(e0) && is_simple(e1)){
                ...
                if(v0.type=='int' && v1.type=='int'){return v0.value+op+v1.value}
                    ...
                    if(v0.type=='int'){
                        ...
                        //res += 'type('+v1.value+')('+v0.value+op+v1.value+') : '
                    }else{
