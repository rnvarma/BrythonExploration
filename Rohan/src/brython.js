...
['id','int','float'].indexOf(elt.tree[0].type)>-1)
}
var e0=this.tree[0],e1=this.tree[1]
if(is_simple(e0)&& is_simple(e1)){var v0=this.tree[0].tree[0]
var v1=this.tree[1].tree[0]
if(v0.type=='int' && v1.type=='int'){return v0.value+op+v1.value}
else if(v0.type!='id' && v1.type!='id'){return 'float('+v0.value+op+v1.value+')'}
else if(v0.type!='id'){var res='(typeof '+v1.value+'.valueOf()=="number") ? '
if(v0.type=='int'){res +='(typeof '+v1.value+'=="number" ? '
res +=v0.value+op+v1.value+' : '
res +='float('+v0.value+op+v1.value+'.value)) : '
}else{res +='float('+v0.value+op+v1.value+') : '
}}else if(v1.type!='id'){var res='(typeof '+v0.value+'.valueOf()=="number") ? '
if(v1.type=='int'){res +='(typeof '+v0.value+'=="number" ? '
res +=v0.value+op+v1.value+' : '
res +='float('+v1.value+op+v0.value+'.value)) : '
}else{res +='float('+v0.value+op+v1.value+') : '
}}else{
if(v0.value==v1.value){var res='(typeof '+v0.value+'.valueOf()=="number") ? '
res +='(typeof '+v0.value+'=="number" ?'
res +=v0.value+op+v1.value+' : '
res +='float('+v0.value+op+v1.value+')) :' 
}else{var res='(typeof '+v0.value+'.valueOf()=="number" &&'
