...
function $extreme(args,op){ // used by min() and max()
    ...
    if(isinstance(second_to_last_arg,$B.$Kw)){
...
_b_.$BaseExceptionDict.__init__ = function(self){
    self.args = [arguments[1]]
}

_b_.$BaseExceptionDict.__repr__ = function(self){
...
_b_.$BaseExceptionDict.__new__ = function(cls){
