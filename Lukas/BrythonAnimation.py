...
class BrythonAnimation(object):
    ...
    def _init_touch(self):
        browser.document.bind("touchstart", lambda event: self._touch(event))
        browser.document.bind("touchmove", lambda event: self._touch(event))
        browser.document.bind("touchend", lambda event: self._touch(event))
        browser.document.bind("touchcancel", lambda event: self._touch(event))
